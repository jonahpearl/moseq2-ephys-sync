...
def test_list_to_events_and_codes():
    ...
    codes = [y for x,y,z,i in ino_codes]
    ...
    def test_arduino_workflow():
        ...
        code_times = [x for x,y,z,i in ino_codes]
        codes_vals = [y for x,y,z,i in ino_codes]
        codes_idx = [i for x,y,z,i in ino_codes]
        assert ino_codes.shape == (64, 4)
        ...
        assert ino_timestamps[codes_idx[0]] == code_times[0]